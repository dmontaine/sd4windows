...
#define SD_PyErr_NotPermitted -12041  /* this session may not use the OS, so may not have Python */
#define SD_PyErr_PrivUnknown  -12042  /* the OS permission could not be determined */
/* END-CODE */