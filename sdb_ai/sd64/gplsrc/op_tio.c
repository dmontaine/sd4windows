          ...
          switch (tio.terminfo_hpa) {
            case 0:
              ...
              /* Modified by Composer AI - 2026/06/10.
                 Intentional fall-through: try "hpa" first, then "cuf". */
            ...
            case 1:
              ...
              tio.terminfo_hpa++;
              /* Modified by Composer AI - 2026/06/10.
                 Intentional fall-through: try "cuf" then emit "cuf1". */
              __attribute__((fallthrough));
              /* -------------------- */
            default:
...
Private int colour_map(int user_colour) {
  ...
  /* Modified by Composer AI - 2026/06/10.
     atoi() has undefined behaviour on overflow; strtol is equivalent for
     valid inputs and returns 0 on garbage like atoi. */
  /* return atoi(p); */
