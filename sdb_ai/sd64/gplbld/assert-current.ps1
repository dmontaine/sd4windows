...
$neverShipped = @(# 16 Sep 26 - RELEASE_1.1 43's relocated-runtime measurement,
                  ...
                  # probe-relayssl.* answers option 2's two falsified-ifs (the
                  # OpenSSL closure, and staging it without colliding with sd's
                  # runtime).  The .c builds an .exe, which stays gitignored.
                  'probe-relocattr.ps1', 'probe-relayssl.ps1', 'probe-relayssl.c',
                  ...
                  'interop-account.ps1',
                  # 15 Sep 26 - verify-elevdoor.ps1, RELEASE_1.1 45's witness
                  ...
                  # 16 Sep 26 - probe-scmrights, the split's second socket-
                  # handover mechanism: does MSYS2 pass a descriptor over
                  # AF_UNIX with SCM_RIGHTS at all?  Measured NO, same token.
                  ...
                  # 14 Sep 26 - verify-nocaseupgrade.ps1, D2's upgrade-walk
                  # witness.  Ships nowhere; listed with the commit that creates it.
