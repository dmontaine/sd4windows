...
#
#   powershell -ExecutionPolicy Bypass -File secure-gcat.ps1 -Path "C:\ProgramData\SD\sdsys\gcat"
#   powershell -ExecutionPolicy Bypass -File secure-gcat.ps1 -Path "C:\ProgramData\SD\sdsys\gpl.bp.out"
#
