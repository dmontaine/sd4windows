...
>
> ***THREE THINGS ARE OPEN AND NONE IS BLOCKED:*** **59** (a real
> non-administrator account for the unelevated half), **56's `adopt` removal**
> — ruled unnecessary, 20 files, deliberately not bundled with the login change
> — and **57's promotion case**, where raising a tier silently strands the
> grants it voids. **58 is the documentation and waits for those.**
>
