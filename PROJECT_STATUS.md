...
>
> ***AND THERE IS A DECISION IN THAT, WHICH IS YOURS.*** 19 is a **`B`** and 38
> is an **`M`**, and everything left in 19 is 38's. Striking 19 and pointing at
> 38 would be tidy and would **quietly move a release blocker onto a minor
> entry**. So **19 stays open and stays `B`** until you say otherwise.
>
