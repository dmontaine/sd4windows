...
>
> # ⇩ STEP 1 IS DONE. THE MECHANISM EXISTS. GO STRAIGHT TO THE BUILD. ⇩
>
> ***NOTHING IS IN FLIGHT. NOTHING IS HALF-BUILT.*** Session 81 spent no cycle
> and touched no product code: it took the measurement step 1 asked for and
> wrote it down. `assert-current` was exit 0 at the start of it.
>
...
>
> ***STEP 2 — NOW BUILD, IN ONE CYCLE:*** `LOGIN`'s `:398` exemption removal
