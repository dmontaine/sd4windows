...
>
> ***SESSIONS 76 AND 77 WERE BOTH DOCUMENTATION-ONLY, SO THE CYCLE IS STILL THE
> FIRST STEP AND THIS BOX IS STILL CURRENT.*** Neither touched `gplsrc` or
> `sdsys`. **Nothing is waiting on the owner** — the six open decisions were
> taken on 29 Aug and **none of the work was started**, so every one of them is
> available to pick up cold. **17 open**, from the checker.
>
> ### ⇩ WHAT TO DO FIRST ⇩
>
