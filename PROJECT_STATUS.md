...
>   changelog. All three are corrected; `DELETE_USER` now removes the
>   **directory** in its own right too. Regenerated PowerShell parses, **0
>   errors and 233 tokens** against 203 before. ***UNCOMPILED — IT NEEDS
>   ANOTHER CYCLE.***
